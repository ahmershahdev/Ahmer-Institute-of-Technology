...
function ait_render_contact(): void
{
    ...
    echo '<input type="hidden" name="recaptcha_v3_token" id="recaptcha-v3-token"><button class="button button-coral" type="submit">Send message <span>↗</span></button></form></div><div class="contact-map-panel"><div class="map-heading"><p class="eyebrow">Find AIT</p><h2>Visit the campus.</h2><p>Main Campus, University Road<br>Jamshoro, Sindh, Pakistan</p></div><iframe title="AIT campus map" src="https://www.openstreetmap.org/export/embed.html?bbox=68.35%2C25.37%2C68.40%2C25.42&amp;layer=mapnik" loading="lazy"></iframe></div></section></main>';
    ait_public_footer();
}
...
function ait_render_faculty(): void
{
    ...
    echo '<main class="inner-page"><section class="inner-hero"><div class="inner-copy"><p class="eyebrow">People who teach with purpose</p><h1>Faculty who open doors.</h1><p class="lede">Our teachers bring scholarship, professional practice, and a generous appetite for better questions into every classroom.</p><a class="button button-coral" href="contact">Connect with AIT <span>↗</span></a></div><div class="inner-art"><img src="assets/images/home/home-slide-2.svg" alt="AIT faculty community"></div></section><section class="content-band"><div class="section-heading"><div><p class="eyebrow">Meet the community</p><h2>Mentors for the work ahead.</h2></div><p>Faculty guidance at AIT moves between classroom concepts, lab practice, research questions, and the decisions that shape a career.</p></div><div class="person-grid">';
    foreach ($people as $person) echo '<article class="person-card reveal"><img src="' . htmlspecialchars($person['image']) . '" alt="' . htmlspecialchars($person['name']) . '"><div><span class="card-number">AIT FACULTY</span><h3>' . htmlspecialchars($person['name']) . '</h3><p>' . htmlspecialchars($person['role']) . '</p></div></article>';
...
function ait_render_departments(): void
{
    ...
    echo '<main class="inner-page"><section class="inner-hero"><div class="inner-copy"><p class="eyebrow">Ideas in conversation</p><h1>Schools that refuse silos.</h1><p class="lede">Our departments share studios, questions, and ambitious problems. That is where unexpected collaborations begin.</p><a class="button button-coral" href="programs">Explore programs <span>↗</span></a></div><div class="inner-art"><img src="assets/images/home/home-slide-2.svg" alt="AIT academic departments"></div></section><section class="content-band"><div class="section-heading"><div><p class="eyebrow">Academic homes</p><h2>Find the people and questions that fit.</h2></div></div><div class="department-grid">';
    foreach ($departments as $department) echo '<article class="department-card reveal"><img src="' . htmlspecialchars($department['image']) . '" alt="' . htmlspecialchars($department['name']) . '"><div class="department-card-body"><span class="card-number">ACADEMIC SCHOOL</span><h3>' . htmlspecialchars($department['name']) . '</h3><p>' . htmlspecialchars($department['text']) . '</p><a href="programs">View programs ↗</a></div></article>';
